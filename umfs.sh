...
nout='&>/dev/null'
est='/home/estudiante'
wall='"https://github.com/developerelianaav/scripts/blob/main/wall.png?raw=true"'
pol='"https://raw.githubusercontent.com/developerelianaav/scripts/refs/heads/main/10-estudiante-policy.pkla"'
